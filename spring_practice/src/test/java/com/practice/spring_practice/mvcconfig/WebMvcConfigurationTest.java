package com.practice.spring_practice.mvcconfig;
...
class WebMvcConfigurationTest {
    ...
    /**
     * 사용자가 "/mvcconfig"로 요청을 보냈을 때 hello.html이 응답되어야 함
     * <p>
    ...
    void addInterceptors() {
        RestAssured
                .given().log().all()
                .when().get("/mvcconfig/admin/members")
                .then().log().all()
