package com.practice.spring_practice.mvcconfig.config;

import com.practice.spring_practice.mvcconfig.ui.AuthenticationPrincipalArgumentResolver;
import com.practice.spring_practice.mvcconfig.ui.LoginInterceptor;
...
public class WebMvcConfiguration implements WebMvcConfigurer {
    ...
    public void addViewControllers(ViewControllerRegistry registry) {
        registry.addViewController("/mvcconfig").setViewName("hello");
    }
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(new LoginInterceptor()).addPathPatterns("/mvcconfig/admin/**");
    }
